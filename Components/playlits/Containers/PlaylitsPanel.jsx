...
import {featureFlippingState} from "../../../utils/States/states";
...
export default function PlaylitsPanel() {
    ...
    const [featureFlipping, setFeatureFlipping] = useRecoilState(featureFlippingState);

    useEffect(() => {
        const userId = getUserId();

        if(userId === "11132933938"){
            setFeatureFlipping(true);
        }
